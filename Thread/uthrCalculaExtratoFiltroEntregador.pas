unit uthrCalculaExtratoFiltroEntregador;
...
type
  ...
  thrCalculaExtratoFiltroEntregador = class(TThread)
  private
...
{ thrCalculaExtratoFiltroEntregador }

uses
  ufrmExtrato, uGlobais;

procedure thrCalculaExtratoFiltroEntregador.Execute;
var
      ...
      begin
        ...
        begin
          ...
          RegExtrato._atrasos := entrega.PrazoExtrato(sExpressaIni,
            sExpressaFim, '', IntToStr(RegExtrato._codigoentregador), '99');
          RegExtrato._qtdvolumesextra := dm.qryGeral.FieldByName
            ('EXTRA').AsFloat;
        ...
        if uGlobais.lAgentes.IndexOf(IntToStr(RegExtrato._codigoentregador)) > -1
        then
        begin
          ...
          begin
            ...
            dm.tbExtratoVAL_VOLUMES_EXTRA.Value := RegExtrato._valpercentualEnt;
...
procedure thrCalculaExtratoFiltroEntregador.LimpaRecord;
begin
  with RegExtrato do
  begin
    _codigoagente := 0;
...
procedure thrCalculaExtratoFiltroEntregador.AtualizaProgress;
begin
...
procedure thrCalculaExtratoFiltroEntregador.TerminaProcesso;
begin
...
procedure thrCalculaExtratoFiltroEntregador.IniciaProcesso;
begin
  frmExtrato.cxGrid1DBTableView1.OptionsView.NoDataToDisplayInfoText :=
