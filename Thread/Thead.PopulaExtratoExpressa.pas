unit Thead.PopulaExtratoExpressa;
...
type
  Thead_PopulaExtratoExpressa = class(TThread)
  private
...
{ 
  ...
  and UpdateCaption could look like,
    ...
    procedure Thead_PopulaExtratoExpressa.UpdateCaption;
    begin
...
{ Thead_PopulaExtratoExpressa }

procedure Thead_PopulaExtratoExpressa.AtualizaProcesso;
begin
...
procedure Thead_PopulaExtratoExpressa.Execute;
begin
  { Place thread code here }
end;

procedure Thead_PopulaExtratoExpressa.IniciaProcesso;
begin
...
procedure Thead_PopulaExtratoExpressa.PopulaExtrato;
var
...
begin
  try
    ...
    begin
      ...
      view_ExtratoExpressas.mtbExtratoVAL_TOTAL_DEBITOS.AsFloat := extratoTMP.ValorDebitos;
...
procedure Thead_PopulaExtratoExpressa.TerminaProcesso;
begin
  sMensagem := '';
  FdPos := 0;
  view_ExtratoExpressas.sbExtrato.Panels[0].Text := '';
