...
type
  Thread_TotalizaEntregas = class(TThread)
  private
    { Private declarations }
    procedure PopulaTotais;
  protected
...
procedure Thread_TotalizaEntregas.Execute;
begin
  { Place thread code here }
end;

procedure Thread_TotalizaEntregas.PopulaTotais;
va
begin
