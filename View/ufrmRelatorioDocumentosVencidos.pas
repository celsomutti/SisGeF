unit ufrmRelatorioDocumentosVencidos;
...
type
  TfrmRelatorioDocumentosVencidos = class(TForm)
    cxLabel16: TcxLabel;
    cxGrid1DBTableView1: TcxGridDBTableView;
    cxGrid1Level1: TcxGridLevel;
    cxGrid1: TcxGrid;
    colCOD_CADASTRO: TcxGridDBColumn;
    colDES_RAZAO_SOCIAL: TcxGridDBColumn;
    colNOM_FANTASIA: TcxGridDBColumn;
  private
...
var
  frmRelatorioDocumentosVencidos: TfrmRelatorioDocumentosVencidos;
