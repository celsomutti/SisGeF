...
uses
  ...
  dxSkinWhiteprint, dxSkinXmas2008Blue, dxSkinscxPCPainter, cxPCdxBarPopupMenu, cxPC, cxLabel, cxImage, Vcl.ExtCtrls;

type
  TfrmBaixaEntregas = class(TForm)
    Panel1: TPanel;
    cxImage1: TcxImage;
    cxLabel16: TcxLabel;
...
var
  frmBaixaEntregas: TfrmBaixaEntregas;
